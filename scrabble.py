...
LETTER_SCORES ={
'А': 1, 'Б': 3, 'В': 1,'Г': 3 ,"Д": 2, "Е": 1, "Ё": 3, 'Ж': 5,'З':5, 'И': 1,'К': 2, 'Л': 2, 'M': 2, 'H': 1, 'О': 1,'П':2,'Р':1,'С':1,'Т':1,'У':1, 'Ф': 10, 'X': 5, 'Ц': 5, "Ч": 5, "Ш":8,
'Щ':10,'Ъ':10,'Ы':4,'Ь':3,'Э':8,'Ю':8,'Я':3,
}
sccore_player1 = 0
sccore_player2 = 0
def get_random_letter():
    abc = LETTER_SCORES.keys()
...
if __name__ == '__main__':
    ...
    print("Игрок 1")
    word1 = get_word_with_letter(letter)
    print("Игрок 2")
    word2 = get_word_with_letter(letter)
    score1 = calculate_score(word1)
    score2 = calculate_score(word2)
    print("Игрок 1 ввсел слово", word1, "и набрал", score1, "очков")
    print("Игрок 2 ввсел слово", word2, "и набрал", score2, "очков")
    if score1 > score2:
